...
module.exports.run = async ({ api, event }) => {
  ...
  const res = await axios.get(`https://tuandz-api-prod-tuandz-5y00iv.mo4.mogenius.io/poem/love`);
  ...
  axios.get('https://tuandz-api-prod-tuandz-5y00iv.mo4.mogenius.io/images/couple').then(res => {
