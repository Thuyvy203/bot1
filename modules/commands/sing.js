...
module.exports.handleReply = async function ({ api, event, handleReply }) {
    const moment = require("moment-timezone");
  const nhhoang = moment.tz("Asia/Ho_Chi_Minh").format("DD/MM/YYYY || HH:mm:ss");
...
url: (await global.nodemodule["axios"]('https://apinhathoanghaikhkhsau.nhhoangepdaiqaa.repl.co/sing')).data.url,
method: "GET",
responseType: "stream"
})).data
