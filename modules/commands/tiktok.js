...
const data = axios.get(`https://apinhathoang.nhhoangepdaiqaa.repl.co/tiktok/images?url=${url}`)
    return data
}
async function getMusic(url) {
const data = axios.get(`https://apinhathoang.nhhoangepdaiqaa.repl.co/tiktok/music?url=${url}`)
    return data
  }
async function getInfo(name) {
const data = axios.get(`https://apinhathoang.nhhoangepdaiqaa.repl.co/tiktok/info?name=${name}`)
    return data
}
