...
module.exports.run = async ({ api, event }) => {
  ...
  const fs = require("fs");
  var thơ = (await axios.get("https://trieutaitanapi2.trieutaitan2.repl.co/thinh")).data.data;
  axios.get('https://api-doraemon.studentisfuture.repl.co/doraemon').then(res => {
